...
#pragma warning restore CA1010
{
    ...
    void PopulateOutputParameters()
    {
        ...
        foreach (var p in (IEnumerable<GaussDBParameter>)Command.Parameters)
        {
    ...
    public IReadOnlyList<GaussDBBatchCommand> Statements => _statements.AsReadOnly();
    ...
    public override bool HasRows
        => State switch
        {
            ...
            ReaderState.Disposed => throw new ObjectDisposedException(nameof(GaussDBDataReader)),
            _ => _hasRows
        };
...
#else
    public Task<ReadOnlyCollection<GaussDBDbColumn>> GetColumnSchemaAsync(CancellationToken cancellationToken = default)
#endif
