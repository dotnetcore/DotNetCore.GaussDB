...
sealed class GaussDBBufferWriter : IStreamingWriter<byte>
{
    readonly GaussDBWriteBuffer _buffer;
    int? _lastBufferSize;
    public GaussDBBufferWriter(GaussDBWriteBuffer buffer) => _buffer = buffer;
