...
public sealed partial class GaussDBConnectionStringBuilder : DbConnectionStringBuilder, IDictionary<string, object?>
{
    ...
    public int Timeout
    {
        ...
        set
        {
            if (value < 0 || value > GaussDBConnection.TimeoutLimit)
                throw new ArgumentOutOfRangeException(nameof(value), value, "Timeout must be between 0 and " + GaussDBConnection.TimeoutLimit);
