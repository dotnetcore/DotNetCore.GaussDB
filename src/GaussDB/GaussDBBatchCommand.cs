...
{
    internal static readonly List<GaussDBParameter> EmptyParameters = new();
...
#else
    /// <summary>
    /// Returns whether the <see cref="GaussDBBatchCommand.CreateParameter"/> method is implemented.
    /// </summary>
