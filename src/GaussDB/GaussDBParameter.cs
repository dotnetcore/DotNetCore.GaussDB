    ...
    public GaussDBDbType GaussDBDbType
    {
        ...
        set
        {
            if (value == GaussDBDbType.Array)
                throw new ArgumentOutOfRangeException(nameof(value), "Cannot set GaussDBDbType to just Array, Binary-Or with the element type (e.g. Array of Box is GaussDBDbType.Array | GaussDBDbType.Box).");
            if (value == GaussDBDbType.Range)
                throw new ArgumentOutOfRangeException(nameof(value), "Cannot set GaussDBDbType to just Range, Binary-Or with the element type (e.g. Range of integer is GaussDBDbType.Range | GaussDBDbType.Integer)");
...
#pragma warning restore CA2227
    ...
    internal void ResolveTypeInfo(PgSerializerOptions options)
    {
        ...
        if (!previouslyResolved)
        {
            ...
            TypeInfo = typeInfo = AdoSerializerHelpers.GetTypeInfoForWriting(valueType, pgTypeId, options, _GaussDBDbType);
        }
        ...
        {
            throw new NotSupportedException(_GaussDBDbType is not null
