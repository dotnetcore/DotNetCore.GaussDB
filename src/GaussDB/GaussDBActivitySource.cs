...
{
    static readonly ActivitySource Source = new("GaussDB", "0.1.0");

    internal static bool IsEnabled => Source.HasListeners();

    internal static Activity? CommandStart(GaussDBConnector connector, string commandText, CommandType commandType)
    {
